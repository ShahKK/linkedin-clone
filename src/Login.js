...
function Login() {
    ...
    <form>
        <input placeholder = 'Full name (required if registering)' value = {name} onChange={e => setName(e.target.value)} type='text'></input>
        <input placeholder= 'Profile pic URL (optional)' value = {profilePic} onChange={e => setProfilePic(e.target.value)} type="text"></input>
